...
**FamiliarLockout**: this indicates if the user is currently in a state of lockout for incorrect password attempts from IP addresses on the list of “FamiliarIps” 

**UnknownLockout**: this indicates if the user is currently in a state of lockout for incorrect password attempts from IP addresses not on the list of “FamiliarIps”
